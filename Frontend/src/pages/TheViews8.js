...
const TheViews8 = () => {
    ...
    useEffect(()=>{
        const fetchViews = async () =>{
            const response =  await fetch('api/views/viewEight')
    ...
    return (
        ...
        <div className="views" >
                ...
                <h1 class="text-left whitespace-nowrap px-4 py-2 font-bold text-xl text-gray-100 border-b-2">View 8</h1>
                <table>
                    <tr>
                    ...
                    {views && views.map((views) => (
                        ...
                        //[{"_id":"6374496c28bb97fe6792ad29","starting_dest":"Kipling","trainJoinTrainS":[{"start_time":"9:00","remaining_capacity":118}]}
                    ))}
                </table>
                </div>
            </div>
